...
Updated maps with water areas and county lines.
...
I make explicit spatial objects for the network nodes (tract centroids) and edges (lines between them). I get trip approximate distances from the line lengths.
...
# run model (model was loaded into workspace; takes a while to run.)
mo <- ergm(
  fo,
